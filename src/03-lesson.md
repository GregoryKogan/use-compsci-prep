...
- [Несколько аргументов](#несколько-аргументов)
...
F(a, b) = 3, если b = 0;  
F(a, b) = 3 \* F(a, b // 3), если b чётно;  
F(a, b) = a \* b + F(a, b - 1), если b нечётно.  
Известно, что F(x, y) = 881025 и x < y. Найдите наименьшее возможное значение y.  
_Ответ: 695_  
**Решение**  
В этой задаче тоже нужно подобрать аргументы, но теперь их два. В остальном всё аналогично.
