...
П2 единственная строка с 2 звездочками, Ж единственная вершина степени 2 (свойство 1) $\Rightarrow$ Ж - П2  
Аналогично Д - П6  
Для вершины Ж известны все соседи кроме одного (свойство 2) $\Rightarrow$ E - П1  
Для вершины Е известны все соседи кроме одного (свойство 2) $\Rightarrow$ Б - П4  
Из двух вершин степени 4 одна уже известна: Б - П4 (свойство 3) $\Rightarrow$ Г - П3  
У вершин Г и Б два общих соседа: в графе это вершины А и Д, а в таблице П6 и П5, причем известно, что Д - П6 (свойство 4) $\Rightarrow$ A - П5  
Аналогично В - П7  
...
Е - единственная вершина степени 3, связанная с П2 $\Rightarrow$ Е - П1  
Б - единственная вершина степени 4, связанная с П1 и П6 $\Rightarrow$ Б - П4  
Г - единственная вершина степени 4, связанная с П4 и П6 $\Rightarrow$ Г - П3  
А - единственная вершина степени 3, связанная с П3 и П4 $\Rightarrow$ А - П5  
В - единственная вершина степени 3, связанная с П3, П5, П6 $\Rightarrow$ В - П7
...
Б - единственная вершина степени 2, связанная с П3 $\Rightarrow$ Б - П2  
А - единственная вершина степени 3, связанная с П2 и П3 $\Rightarrow$ А - П4  
Д - единственная вершина степени 3, связанная с П3 и П4 $\Rightarrow$ Д - П6  
