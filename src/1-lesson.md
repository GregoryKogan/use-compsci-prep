...
**Матрица смежности** — это квадратная матрица $A = ||a_{ij}||$, в которой элемент $a_{ij}$ равен числу рёбер, соединяющих вершины $v_i$ и $v_j$. Для взвешенного графа $a_{ij}$ равно весу ребра, соединяющего вершины $v_i$ и $v_j$. В ЕГЭ кратные рёбра встречаются очень редко, поэтому для невзвешенных графов $a_{ij}$ равно `1`, если вершины $v_i$ и $v_j$ смежны, и `0` в противном случае. Часто в условиях задач матрица смежности представлена в виде таблицы, где `1` обозначается звездочкой, а `0` - пустой клеткой.

[^1]:
    Подробнее о графах можете почитать на [Хабре](https://habr.com/ru/companies/otus/articles/568026/) и в [вики-конспектах ИТМО](https://neerc.ifmo.ru/wiki/index.php?title=%D0%A2%D0%B5%D0%BE%D1%80%D0%B8%D1%8F_%D0%B3%D1%80%D0%B0%D1%84%D0%BE%D0%B2).  
    [@otusgraphtheory], [@itmographtheory]
